...
insert into emails (content, is_primary, user_id) values ('hello@gmail.com', true, 1);
insert into emails (content, is_primary, user_id) values ('asdfg@gmail.com', false, 1);
